...
CATALOG: list[Metric] = [
    ...
    Metric("cpu.temp_ccd1", "CPU CCD1", "°C", "temp", C["maroon"],
           (_t(CPU, "CCD1 (Tdie)"),),
           fallback_ids=("/amdcpu/0/temperature/3",), default_on=False, short="CCD1"),
    ...
    Metric("gpu.temp_vram", "GPU Mem Junction", "°C", "temp", C["lavender"],
           ...
           fallback_ids=("/gpu-nvidia/0/temperature/3",), default_on=False, short="VRAM"),
    Metric("board.temp_vrm", "VRM MOS", "°C", "temp", C["peach"],
           (_t(LPC, "VRM MOS"),),
           fallback_ids=("/lpc/nct6687dr/0/temperature/2",), default_on=False, short="VRM"),
    Metric("board.temp_sys", "Motherboard", "°C", "temp", C["subtext"],
           (_t(LPC, "System"),),
           fallback_ids=("/lpc/nct6687dr/0/temperature/1",), default_on=False, short="Board"),
    ...
    Metric("fan.sys5", "System Fan #5", "%", "fan", C["lavender"],
           (_c(LPC, "System Fan #5"),),
           fallback_ids=("/lpc/nct6687dr/0/control/14",), default_on=False, short="Sys #5"),
    Metric("fan.sys6", "System Fan #6", "%", "fan", C["mauve"],
           (_c(LPC, "System Fan #6"),),
           fallback_ids=("/lpc/nct6687dr/0/control/15",), default_on=False, short="Sys #6"),
    Metric("fan.ezconnect", "EZ-Connect Fan", "%", "fan", C["yellow"],
           (_c(LPC, "EZ-Connect Fan"),),
           fallback_ids=("/lpc/nct6687dr/0/control/3",), default_on=False, short="EZ-Connect"),
    ...
    Metric("rpm.sys5", "System Fan #5", "RPM", "rpm", C["lavender"], (_f(LPC, "System Fan #5"),), default_on=False, short="Sys #5"),
    Metric("rpm.sys6", "System Fan #6", "RPM", "rpm", C["mauve"], (_f(LPC, "System Fan #6"),), default_on=False, short="Sys #6"),
    Metric("rpm.ezconnect", "EZ-Connect Fan", "RPM", "rpm", C["yellow"], (_f(LPC, "EZ-Connect Fan"),), default_on=False, short="EZ-Connect"),
